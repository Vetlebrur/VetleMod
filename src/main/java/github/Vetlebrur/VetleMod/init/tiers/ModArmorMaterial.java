...
public class ModArmorMaterial implements ArmorMaterial {
    ...
    public ModArmorMaterial(int[] durabilityForType, int[] defenseForType,
                            int enchantability, SoundEvent equipSound,
                            Supplier<Ingredient> repairMaterial, String name,
    ...
    @Override
    public int getDurabilityForType(ArmorItem.Type type){return this.durabilityForType[type.ordinal()];}

    @Override
    public int getDefenseForType(ArmorItem.Type type){return this.defenseForType[type.ordinal()];}
    ...
    @Override
    public String getName(){return VetleMod.MODID+":"+this.name;}
